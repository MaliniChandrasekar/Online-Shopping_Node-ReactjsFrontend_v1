...
const Furniture = () => {
  ...
  const handleSubmit = (event) => {
    axios.get("http://localhost:8080/product/Home Decor")
      .then((res) => {
  ...
  return (
    <div>
      ...
      <div className='container'>
        <br></br>
        <h1 className='text-center' style={{ fontSize: '28px', color: '#84cdee', fontWeight: 'bold' }}><font style={{ color: "black" }}>H</font>omeDecors</h1>
        <br></br>
